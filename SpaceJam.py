...
class myApp(ShowBase):
    ...
    def Scene(self):
        ...
        self.Player = Spacejamclasses.Player(self.loader, "./Assets/Player/hornetMini.x", self.render, 'Player', "./Assets/Player/hornetMini.jpg", (-4000, -2000, 67), 50, self.task_mgr, self.render)
